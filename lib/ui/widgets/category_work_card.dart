...
class CategoryWorkCard extends StatelessWidget {
  final CategoryProjectModel categoryWork;
  final Function onTap;

  CategoryWorkCard(this.categoryWork, {this.onTap});
